        ...
        .with_children(|root| {
            ...
            .with_children(|toolbox| {
                toolbox.spawn((
                    Text::new(match editor_session.mode {
                        ...
                        EditorMode::Station => "Station Debug".to_string(),
                    }),
                    TextFont {
                    ...
                    .with_children(|ship_name| {
                        ship_name.spawn((
                            Text::new(match editor_session.mode {
                                ...
                                EditorMode::Station => "Station Name",
                            }),
                            TextFont {
                    ...
                    .with_children(|viewport| {
                        viewport
                            ...
                            .with_children(|content| {
                                        ...
                                        .with_children(|components| {
                                                if editor_session.mode == EditorMode::Station {
                                                    ...
                                                    spawn_station_tool_button_grid(
                                                        components,
                                                        &mono_font,
                                                        station_editor_state.selected_tool,
                                                    );
                                                }
                                ...
                                if editor_session.mode == EditorMode::Enemy {
                                    ...
                                    for (label, marker) in [
                                        ...
                                        let button = match marker {
                                            ...
                                            _ => button.insert(EnemyNextButton),
                                        };
                                        button.with_child((
                                            Text::new(label),
                                            TextFont {
                                ...
                                if editor_session.mode == EditorMode::Station {
                                    if let Some(station) = station_catalog
                                        .0
                                        .stations
                                        .get(station_editor_state.selected_station_index)
                                    {
                                        content.spawn((
                                            Text::new(format!(
                                                ...
                                                station.name,
                                                station.id,
                                                station.ship.foundation_tiles.len()
                                                    + station.ship.hull_tiles.len(),
                                                station.ship.modules.len()
                                            )),
                                            TextFont {
                                                font: mono_font.clone(),
                                                font_size: UI_BODY_FONT_SIZE,
                                    ...
                                    for (label, marker) in [
                                        ...
                                        let button = match marker {
                                            0 => button.insert(StationPrevButton),
                                            _ => button.insert(StationNextButton),
                                        };
                                        button.with_child((
                                            Text::new(label),
                                            TextFont {
                                    ...
                                    content
                                        ...
                                        .with_child((
                                            Text::new(station_editor::station_config_references_text(
                                                &sector_state,
                                                &station_catalog,
                                            )),
                                            TextFont {
                ...
                toolbox
                    ...
                    .with_child((
                        Text::new(match editor_session.mode {
                            ...
                            EditorMode::Station => "Return To Menu",
                        }),
                        TextFont {
                            font: mono_font.clone(),
            ...
            root.spawn((
                Node {
                    ...
                    display: if editor_session.mode == EditorMode::Station {
                        Display::None
                    } else {
                        Display::Flex
                    },
                ...
                panel.spawn((
                    Text::new(
                        match editor_session.mode {
                            ...
                            EditorMode::Enemy => "Enemy Editor Controls\nUnlimited component supply across all variants\nBuild mode: left drag place, right drag erase\nSelect mode: drag marquee, arrows move group, Ctrl+C / Ctrl+V copy and paste, Delete removes, H runs Auto Hull\nE: inspect hovered component\nQ: close component console\nR: rotate build variant clockwise\nZ / X: previous / next variant\nC / V: channel - / + in build mode\nF10: ignore component limits\nScroll over toolbox: browse parts\nScroll over grid: zoom\nMiddle drag: pan view\nF5 save library  |  F9 reload library\n[ / ] cycle referenced entry\nTab: return to menu",
                            EditorMode::Station => "Station Editor Controls\nBuild mode: left drag place, right drag erase\nStation tools place floor, wall, prop, dock anchor, or service NPCs\nScroll over toolbox: browse tools\nScroll over grid: zoom\nMiddle drag: pan view\nF5 save stations  |  F9 reload stations\nTab: return to menu",
                        },
                    ),
                    TextFont {
                        font: mono_font.clone(),
